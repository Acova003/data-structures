...
def sort_by_cohort(filename):
    ...
    for line in data_file:
        ...
        #Remove instructors and ghosts
        if cohort not in ["I", "G"]:
            all_students.append(name)

        #Worry about which cohort
...
def students_by_house(filename):
    ...
    for line in data_file:
        ...
        if house == "Gryffindor":
            gryffindor.append(l_name)
        elif house == "Hufflepuff":
            hufflepuff.append(l_name)
        elif house == "Slytherin":
            slytherin.append(l_name)
        elif house == "Ravenclaw":
            ravenclaw.append(l_name)
        elif house == "Dumbledore's Army":
            dumbledores_army.append(l_name)

        if cohort == "I":
            instructors.append(l_name)
        elif cohort == "G":
            ghosts.append(l_name)
        else:
            all_students.append(l_name)
